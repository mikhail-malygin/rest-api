...
public class DemoWebShopsTests {
    ...
    @Test
    void addNewProductToCartAsAnonymTest() {
    ...
    @Test
    void addOldProductToCartAsAnonymTest() {
        /*
    ...
    @Test
    void addOldProductToCartAsAuthorizedTest() {
    ...
    @Test
    void addOldProductToCartAsAuthorizedSizeInWebTest() {
